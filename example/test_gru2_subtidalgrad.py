...
def test_gru_multi():
    ...
    input_names = [ "sac_flow","exports","sjr_flow","cu_flow","sf_tidal_energy","sf_dsub","dcc","smscg"]
    ...
    xvalid_fit_multi(df_in,df_out,builder,plot_folds="all",plot_locs=plot_locs,
                     out_prefix="output/dsm2_gru2.tanh.elu.lowreg.ecscale.mae.v2",nepochs=100,pool_size=10)
