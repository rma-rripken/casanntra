...
class MLPBuilder68(ModelBuilder):
    ...
    def build_model(self,input_layers, input_data):
        ...
        # First hidden layer 
        x = Dense(units=12, activation='sigmoid', input_dim=x.shape[1], 
...
def test_xvalid_mlp():
    ...
    builder = MLPBuilder(input_names=input_names,
    ...
    xvalid_fit(df_in,df_out,builder,plot_folds="all",plot_locs=plot_locs,out_prefix="output/schism_mlp.12.12.mae")
