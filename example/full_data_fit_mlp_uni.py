...
from test_mlp_uni import MLPUniBuilder
...
def example_mlp1():
    ...
    builder = MLPUniBuilder(input_names=input_names,output_names=output_names,ndays=14,nwindows=5,window_length=14)
    ...
    #
    fname = "full_data_fit_mlp_uni.keras"
    #model = load_model(fname)
    history, model = builder.fit_model(model, fit_in, df_out_aligned, test_in, df_out_aligned,nepochs=300)
